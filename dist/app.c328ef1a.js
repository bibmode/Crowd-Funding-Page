...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  {
    "../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js":
      [
    ...
    "../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js":
      [
        function (require, module, exports) {
    ...
    "sass/main.scss": [
      ...
      {
        "./..\\images\\image-hero-desktop.jpg": [
          ["image-hero-desktop.1cb3e33a.jpg", "images/image-hero-desktop.jpg"],
          "images/image-hero-desktop.jpg",
        ],
        _css_loader:
          "../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js",
    ...
    "app.js": [
      function (require, module, exports) {
        ...
        function toggleShow(num) {
          document.querySelector("#amount__".concat(num)).style.visibility =
            "visible";
          document.querySelector("#amount__".concat(num)).style.height =
            "100px";
          document.querySelector("#amount__".concat(num)).style.padding =
            "1rem";
          document.querySelector(".offer-".concat(num)).style.display = "none";

          if (num !== 6) {
            document.querySelector("#amount__text--".concat(num)).innerHTML =
              "Enter your pledge";
          }
        }
        ...
        amountBtns.forEach(function (btn) {
          btn.addEventListener("click", function (e) {
            var inputAmount = document.querySelector(
              "#amount__input--".concat(numOpen)
            ).value;
            if (numOpen === 1) add = 4;
            if (numOpen === 2) add = 5;
            if (numOpen === 4) add = 1;
        ...
        function amountValidation(amount, open, add) {
          if (amount < arr[open]) {
            document.querySelector("#amount__text--".concat(open)).innerHTML =
              "Pledge must be atleast $".concat(arr[open]);
          ...
          if (amount >= arr[open] && amount < arr[open + 1]) {
            document.querySelector("#amount__text--".concat(open)).innerHTML =
              "Enter your pledge";
            var val = Number(
              document.querySelector("#offer__price--".concat(open)).innerHTML
            );
            val--;
            document.querySelector("#offer__price--".concat(open)).innerHTML =
              "".concat(val);
            var val2 = Number(
              document.querySelector("#offer__price--".concat(add)).innerHTML
            );
            val2--;
            document.querySelector("#offer__price--".concat(add)).innerHTML =
              "".concat(val2);
          ...
          if (amount >= arr[open + 1]) {
            document.querySelector("#amount__text--".concat(open)).innerHTML =
              "Enter an amount less than $".concat(arr[open + 1]);
            document.querySelector("#amount__input--".concat(open)).value = "";
          }
